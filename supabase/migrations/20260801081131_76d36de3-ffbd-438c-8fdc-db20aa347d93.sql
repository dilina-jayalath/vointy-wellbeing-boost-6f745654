...
CREATE OR REPLACE FUNCTION public.org_has_active_subscription(org_uuid uuid, check_env text DEFAULT 'live')
RETURNS boolean
LANGUAGE sql
STABLE
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.org_has_active_subscription(uuid, text) TO authenticated, service_role;